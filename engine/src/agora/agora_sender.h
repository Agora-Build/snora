...
public:
  ...
  // num_samples: total interleaved samples (FRAME_SAMPLES = 960 for stereo
  // 10ms).
...
private:
  ...
  public:
    ...
    void
    onConnected(const agora::rtc::TConnectionInfo &info,
                agora::rtc::CONNECTION_CHANGED_REASON_TYPE reason) override;
    void
    onDisconnected(const agora::rtc::TConnectionInfo &info,
                   agora::rtc::CONNECTION_CHANGED_REASON_TYPE reason) override;
    void
    onConnecting(const agora::rtc::TConnectionInfo &info,
                 agora::rtc::CONNECTION_CHANGED_REASON_TYPE reason) override;
    void
    onReconnecting(const agora::rtc::TConnectionInfo &info,
                   agora::rtc::CONNECTION_CHANGED_REASON_TYPE reason) override;
    void
    onReconnected(const agora::rtc::TConnectionInfo &info,
                  agora::rtc::CONNECTION_CHANGED_REASON_TYPE reason) override;
